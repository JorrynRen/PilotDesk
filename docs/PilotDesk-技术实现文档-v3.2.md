# PilotDesk 技术实现文档 v3.2

> 版本: v3.2 | 作者: 简意工作室 (jorryn) | 日期: 2026-06
...
| **v3.2** | **2026-06-03** | **Hermes YAML 兼容性修复 + Agent 配置表单切换/刷新/保存反馈修复 + 字段重新编排（Base URL→API Key→模型→自定义系统提示词）+ Temperature/最大Tokens 去除 + 空值保存允许 + HermesConfigPublic rename_all** |
